...
public class BehaviorParam {
	...
	public static final String[] MOVE_DIRECTION_NAMES = {"Forward", "Backward"};
	public enum MoveDirection {FORWARD, BACKWARD};
	
	public static final String[] PIVOT_DIRECTION_NAMES = {"Left", "Right"};
	public enum PivotDirection {LEFT, RIGHT};
	
	public static final String[] ARC_DIRECTION_NAMES = {"Forward Left", "Forward Right", "Backward Left", "Backward Right"};
